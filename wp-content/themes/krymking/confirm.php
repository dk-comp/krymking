...
<div style="float: left;"><a href="http://www.krymking.ru" style="display: inline-block; margin-top: 20px; text-decoration: none; color: blue;">Krymking.ru</a><br>
    <span style="display: inline-block; margin-top: 20px;">
        <a style="text-decoration: none; color: blue;" href="https://vk.com/krymking">VK</a>
        <a style="text-decoration: none; color: blue;" href="https://www.facebook.com/Krymkingru-106685441598072">FB</a>
        <a style="text-decoration: none; color: blue;" href="https://www.instagram.com/krymking.ru/">INSTA</a>
        <a style="text-decoration: none; color: blue;" href="https://ok.ru/krymking.ru">OK</a>
        <a style="text-decoration: none; color: blue;" href="https://t.me/krymkingru">TM</a>
    </span>
</div>
...
?>
    ...
    <div class="wrapper">
        ...
        <? if (!empty($data)) {
            ...
            //Тут вызываешь отправку письма
            // $userData['email'] - емейл куда высылать
