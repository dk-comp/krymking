...
function dimox_breadcrumbs() {
	...
	$text['search']   = 'Результаты поиска: "%s" '; // text for a search results page
	$text['tag']      = 'Тег: "%s"'; // text for a tag page
	$text['author']   = 'Автор: %s'; // text for an author page
	$text['404']      = 'Ошибка 404'; // text for the 404 page
	$text['page']     = 'Страница %s'; // text 'Page N'
	$text['cpage']    = 'Стреница комментариев %s'; // text 'Comment Page N'
