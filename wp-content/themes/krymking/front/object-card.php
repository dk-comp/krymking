...
$address = hotel_address($post->ID);
}*/?>
<?php /*if($category_title === $address): */?>
	...
	<div class="hotel-content">
		...
		<div class="hotel-address"><?=$a = hotel_address($post->ID);?> <div data-id="<?=$post->ID;?>" class="map-link">Показать на карте</div></div>
		<?=properties_romms();?>
...
<?php /*elseif(strpos(hotel_address($post->ID), $category_title)):*/?><!--
	<div class="hotel-item">
		<div class="hotel-image">
			<a href="<?/*=get_permalink();*/?>" target="_blank">
				<?/*=the_post_thumbnail(array(355, 330));*/?>
