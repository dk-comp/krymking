<?php
if ( is_page(array(255, 69)) ) {
	wp_redirect( '/poisk-zhilya/' );
}

get_header();
/* Template Name: Справочник Гостя */
global $current_user;
?>
...
<div class="wrapper">
	...
	<div class="handbook-header">
		...
		<div class="handbook-switch">
			<a href="/gostyam/" class="active">Справочник Гостя</a>
			<a href="/vladelczam/" >Справочник Владельца</a>
		</div>
	</div>
	<div class="handbook-wrap">
		<div class="handbook-left">
			<?php wp_nav_menu( array(
			'menu'        => 'Справочник Гостя', 
			'container'  => false,
